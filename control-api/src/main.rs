...
mod tests {
    ...
    fn verifies_node_handshake_signature() {
        let body = br#"{"node_id":1,"node_version":"0.25.2","os":"linux","arch":"x86_64","boot_id":"boot-1","timestamp":1779250000,"nonce":"handshake-nonce","config_revision":1,"listen_addr":"0.0.0.0:666"}"#;
        let timestamp = now_unix();
