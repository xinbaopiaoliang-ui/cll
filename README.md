...
next stage. Version `0.25.2` keeps the legacy TCP/UDP `ping` probe, supports
...
game-to-node target mappings without direct MySQL access. Version `0.25.2`
refines the `/admin` header typography and status strip so page titles read
more like a modern operations console. Version `0.25.1` fixes startup schema
